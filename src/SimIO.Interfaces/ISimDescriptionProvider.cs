...
using SimIO.Interfaces.Wrapper;
using SimIO.Providers;
...
namespace SimIO.Interfaces.Providers
{
	...
	public interface ISimDescriptions : ICommonPackage
	{
		...
		ISDesc FindSim(ushort instance);
        ...
        /// </summary>
        /// <returns></returns>
        CollectibleAlias[] GetAllCollectibles();
        #endregion
	}
}
