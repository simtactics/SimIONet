...
namespace SimIO.Interfaces.Scenegraph
{
	/// <summary>
	...
	public interface IScenegraphFileIndex
	{
		...
		void AddIndexFromPackage(IPackageFile package, bool overwrite);
		...
		/// <param name="package">The package File</param>
		/// 
		void AddIndexFromPackage(IPackageFile package);
		...
		void AddTypesIndexFromPackage(IPackageFile package, uint type, bool overwrite);
		...
		void AddIndexFromPfd(IPackedFileDescriptor pfd, IPackageFile package);
		...
		void AddIndexFromPfd(IPackedFileDescriptor pfd, IPackageFile package, uint localgroup);
		...
		IScenegraphFileIndexItem[] FindFile(IPackedFileDescriptor pfd, IPackageFile pkg);
		...
		/// <returns>all FileIndexItems</returns>
		IScenegraphFileIndexItem[] FindFile(uint type, uint group, ulong instance, IPackageFile pkg);
		...
		/// <param name="instance">Instance Number of the File</param>
		/// <returns>all FileIndexItems</returns>
		IScenegraphFileIndexItem[] FindFileDiscardingHighInstance(uint type, uint group, uint instance, IPackageFile pkg);
		...
		/// <param name="pfd">The File you are looking for</param>
		/// <returns>all FileIndexItems</returns>
		IScenegraphFileIndexItem[] FindFileDiscardingGroup(IPackedFileDescriptor pfd);
		...
		/// </param>
		/// <returns>The first matching File or null if none</returns>
		IScenegraphFileIndexItem FindSingleFile(IPackedFileDescriptor pfd, IPackageFile pkg, bool betolerant);
		...
		/// <returns></returns>
		IScenegraphFileIndexItem CreateFileIndexItem(IPackedFileDescriptor pfd, IPackageFile pkg);
		
		/// <summary>
		/// Remove the trace of a Package from the FileTable
		/// </summary>
		/// <param name="pkg"></param>
		void ClosePackage(IPackageFile pkg);

		/// <summary>
		/// Returns the List of all Folders this FileIndex is processing
		/// </summary>
		ArrayList BaseFolders
		{
			get;set;
		}
		...
		/// <returns></returns>
		bool Contains(IPackageFile pkg);
